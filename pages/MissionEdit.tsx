...
const MissionEdit = () => {
  ...
  const submission_type = obj.submission_type;
  console.log(submission_type)
  console.log("missionOBJ",obj)
      ...
      <div className="h-screen min-w-fit bg-[#171C23] flex">
        ...
        <div className="w-full h-full overflow-auto scrollbar-hide ">
          ...
          <div className="flex-[1]">
            <div className="w-full h-[115px] border-t-[1px] border-b-[1px] border-[#353B43] px-6 py-7 sticky top-[80px] bg-[#171C23] z-10">
            ...
            <div className="h-full flex justify-between">
              ...
              <div className="h-full w-full flex justify-center">
                <div className="h-auto w-auto mt-[28px]  ">
                  ...
                  <SubmissionCard rendertrue={handleTrue} referralUrl={obj.referralUrl} validationUrl={obj.validationUrl} />
